...
import { MdRestaurant, MdOutlineCalendarToday } from "react-icons/md";
...
export const BookingForm = () => {
  ...
  const tableSchema = yup.object().shape({
    ...
    // guests: yup
    //   .number()
    //   .min(1, "minimum guests you should invite!")
    //   .max(10, "maxmimum guests you should invite!")
    //   .required("Required"),
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (returnVal) {
        ...
        navigateTo = navigate("CustomerForm");
        ...
        >
          <div className="mb-3 flex w-1/2 items-center justify-start md:mb-10 md:justify-between">
            ...
            <input
              ...
              // className=" h-8 w-8"
              className={`seating ${
                formik.touched.seating && formik.errors.seating ? "error" : " "
              } `}
            />
          </div>
          <div className="mb-3 flex w-1/2 items-center justify-start md:mb-10 md:justify-between">
        ...
        <div className="mt-4 flex w-full justify-between md:flex-col md:space-y-5">
          ...
          <div className="relative mb-3 w-1/2">
            <label
              ...
              className="mb-2 block font-semibold text-secondary-300"
            >
              <MdOutlineCalendarToday className="absolute left-4 top-12 z-20 text-2xl font-semibold text-primary-200" />
              Choose Time
            </label>
            <select
              id="resTime"
