...
export const Navbar = () => {
  ...
  return (
    <nav className="custom-container align-center flex h-20 justify-between bg-white pl-6 text-primary-200 lg:blur-none">
      <Link to="/" className="self-center  lg:-order-first">
      ...
      >
        <span class="relative h-[10rem] w-[10rem]">
          <img src={cart} className="w-18 h-10" />
          <span class=" absolute left-6 top-4 flex h-6 w-6  items-center justify-center rounded-full bg-primary-100 text-primary-200">
            2
          </span>
        </span>
      </a>
      <ul className="max-w-1/2 text-md  flex items-center justify-between font-secondary font-semibold capitalize">
        ...
        />
        <NavHashList title={"Menu"} href={"#menu"} display={"flex lg:hidden"} />
        {/* <NavLinkList
          title={"Reservation"}
          to="/reserve"
          display={"flex lg:hidden"}
        ...
        <span
          ...
          className="hidden rounded-sm bg-secondary-300 px-3 py-2 hover:cursor-pointer lg:flex"
        >
      ...
      >
        ...
        <NavLinkList title={"Reservation"} to={"/reserve"} display={"flex "} />
